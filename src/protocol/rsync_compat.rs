...
#![allow(clippy::unreadable_literal)] // Protocol constants are clearer without separators
#![allow(clippy::missing_const_for_fn)] // Protocol functions may become async
#![allow(clippy::uninlined_format_args)] // Protocol error messages
...
#![allow(clippy::cast_lossless)] // Explicit casts for protocol clarity
#![allow(clippy::no_effect_underscore_binding)] // Protocol spec has unused fields
#![allow(clippy::too_many_lines)] // Protocol implementation is complex
