...
mod tests {
    ...
    fn test_all_translation_keys_have_pirate_translations() {
        ...
        let all_keys = vec![
            ...
            TranslationKey::ProgressDiscovered,
            TranslationKey::ProgressCompleted,
            TranslationKey::ProgressInFlight,
            TranslationKey::ProgressComplete,
            TranslationKey::ProgressFiles,
            TranslationKey::ProgressBytes,
            TranslationKey::ProgressSpeed,
            TranslationKey::ProgressEta,
            // Status messages
            TranslationKey::StatusCopyingFile,
            TranslationKey::StatusCopyingDirectory,
            TranslationKey::StatusCreatingSymlink,
            TranslationKey::StatusCreatingHardlink,
            TranslationKey::StatusPreservingMetadata,
            TranslationKey::StatusComplete,
            TranslationKey::StatusFailed,
            // Error messages
            TranslationKey::ErrorFileNotFound,
            TranslationKey::ErrorPermissionDenied,
            TranslationKey::ErrorIoError,
            TranslationKey::ErrorInvalidPath,
            TranslationKey::ErrorSourceNotExists,
            TranslationKey::ErrorDestinationExists,
            // Info messages
            TranslationKey::InfoStartingCopy,
            TranslationKey::InfoScanningSource,
            TranslationKey::InfoCreatingDestination,
            TranslationKey::InfoPreservingPermissions,
            TranslationKey::InfoPreservingOwnership,
            TranslationKey::InfoPreservingTimestamps,
            TranslationKey::InfoPreservingXattrs,
            TranslationKey::InfoPreservingAcls,
            TranslationKey::InfoDryRun,
            // CLI help messages
            TranslationKey::HelpDescription,
            TranslationKey::HelpSource,
            TranslationKey::HelpDestination,
            TranslationKey::HelpArchive,
            TranslationKey::HelpRecursive,
            TranslationKey::HelpLinks,
            TranslationKey::HelpPerms,
            TranslationKey::HelpTimes,
            TranslationKey::HelpGroup,
            TranslationKey::HelpOwner,
            TranslationKey::HelpDevices,
            TranslationKey::HelpXattrs,
            TranslationKey::HelpAcls,
            TranslationKey::HelpHardLinks,
            TranslationKey::HelpVerbose,
            TranslationKey::HelpQuiet,
            TranslationKey::HelpProgress,
            TranslationKey::HelpDryRun,
            TranslationKey::HelpPirate,
            TranslationKey::HelpQueueDepth,
            TranslationKey::HelpMaxFilesInFlight,
            TranslationKey::HelpCpuCount,
            TranslationKey::HelpBufferSize,
            // Units
            TranslationKey::UnitBytes,
            TranslationKey::UnitKilobytes,
            TranslationKey::UnitMegabytes,
            TranslationKey::UnitGigabytes,
            TranslationKey::UnitSeconds,
            // Misc
            TranslationKey::MiscIn,
            TranslationKey::MiscOf,
            TranslationKey::MiscAverage,
            TranslationKey::MiscTotal,
        ];

        let mut missing_translations = Vec::new();
        let mut identical_translations = Vec::new();
        ...
        for key in &all_keys {
            ...
            // Check pirate translation exists (not missing)
            if pirate.contains("[Missing translation:") {
                missing_translations.push(format!("{:?}", key));
            }

            // Check pirate translation is different from English
            // (exceptions: some punctuation/symbols might be the same)
            if english == pirate && !english.is_empty() {
                identical_translations.push(format!("{:?}: '{}' == '{}'", key, english, pirate));
            }
        }
        ...
        if !identical_translations.is_empty() {
            // This is a warning - some translations might legitimately be identical
            println!(
                "Warning: {} translation keys have identical English and Pirate translations:\n{}",
                identical_translations.len(),
                identical_translations.join("\n")
            );
        }

        println!(
            "✅ All {} translation keys have pirate translations!",
            total_keys
        );
    }
}
